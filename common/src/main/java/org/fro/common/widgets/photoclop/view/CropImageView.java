...
import org.fro.common.widgets.photoclop.util.CubicEasing;
import org.fro.common.widgets.photoclop.util.RectUtils;
...
public class CropImageView extends TransformImageView {
    ...
    private int topRectMargin = 250; // 剪裁上边距
    private int rectHeight = 400; // 剪裁高度
    ...
    public void setTargetAspectRatio(float targetAspectRatio) {
        ...
        setupCropBounds(topRectMargin, rectHeight);
        postInvalidate();
    }
     ...
     * @param height
     */
    private void setupCropBounds(int topMargin, int height) {
        mCropRect.set(0, topMargin, mThisWidth, height + topMargin);
    ...
    public void setTopRectMargin(int topRectMargin) {
        this.topRectMargin = topRectMargin;
    }
