...
import org.fro.common.widgets.tab.roundtextview.RoundTextView;
...
import org.fro.common.widgets.tab.tablayout.utils.FragmentChangeManager;
import org.fro.common.widgets.tab.tablayout.utils.UnreadMsgUtils;
...
public class CommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    * */
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mTextsize = ta.getDimension(R.styleable.CommonTabLayout_tl_textsize, sp2px(11f));
        ...
        mIconMargin = ta.getDimension(R.styleable.CommonTabLayout_tl_iconMargin, dp2px(2f));
        ...
        if (mTabSpaceEqual || mTabWidth > 0) {
            mTabPadding = ta.getDimension(R.styleable.CommonTabLayout_tl_tab_padding, dp2px(0));
        } else {
            mTabPadding = ta.getDimension(R.styleable.CommonTabLayout_tl_tab_padding, dp2px(10));
        }
    ...
    * */
    ...
    private void updateTabStyles() {
        for (int i = 0; i < mTabCount; i++) {
            ...
            TextView tv_tab_title = (TextView) tabView.findViewById(R.id.tv_tab_title);
//            tv_tab_title.setTextColor(i == mCurrentTab ? mTabEntities.get(i).getTabTitleColor() : mTabEntities.get(i).getTabTitleColorUn());
...
//            tab_title.setTextColor(isSelect ? mTabEntities.get(i).getTabTitleColor() : mTabEntities.get(i).getTabTitleColorUn());
            ImageView iv_tab_icon = (ImageView) tabView.findViewById(R.id.iv_tab_icon);
            CustomTabEntity tabEntity = mTabEntities.get(i);
            if (isSelect) {
                    iv_tab_icon.setImageResource(tabEntity.getTabSelectedIcon());
