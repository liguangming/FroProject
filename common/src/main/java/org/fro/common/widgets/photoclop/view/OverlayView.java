package org.fro.common.widgets.photoclop.view;
...
public class OverlayView extends View {
    ...
    // 裁剪网格距顶边距的高度
    protected int mReactMarginTop = 125;

    // 裁剪网格的高度
    protected int mReactHeight = 200;
...
//                    getPaddingLeft() + mThisWidth, getPaddingTop() + height + halfDiff);
            mCropViewRect.set(getPaddingLeft(), mReactMarginTop,
                    getPaddingLeft() + mThisWidth, mReactMarginTop + mReactHeight);
        }
    ...
    private void initCropFrameStyle(@NonNull TypedArray a) {
        ...
        mReactMarginTop = a.getInt(R.styleable.ucrop_UCropView_ucrop_react_margin_top, 125);
        mReactHeight = a.getInt(R.styleable.ucrop_UCropView_ucrop_react_margin_top, 200);
    ...
    public void setmReactHeight(int mReactHeight) {
        this.mReactHeight = mReactHeight;
    }

    public void setmReactMarginTop(int mReactMarginTop) {
        this.mReactMarginTop = mReactMarginTop;
    }
}
