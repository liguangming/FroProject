...
public class ModifyUserInfoPresenter extends BasePresenter<ModifyUserInfoContract.Model, ModifyUserInfoContract.View> {
    ...
    int orgDetailId = MyApplication.getInstance().getUserInfoBean().getOrganizationResponse() != null ? MyApplication.getInstance().getUserInfoBean().getOrganizationResponse().getId() : DEFAULT_ID;
    int workYearId = MyApplication.getInstance().getUserInfoBean().getWorkYearResponse() != null ? MyApplication.getInstance().getUserInfoBean().getWorkYearResponse().getId() : DEFAULT_ID;
    int orgTypeId = MyApplication.getInstance().getUserInfoBean().getCategoryResponse().getId();
    int orgNatureID = MyApplication.getInstance().getUserInfoBean().getNatureResponse().getId();
    int credentialsId = MyApplication.getInstance().getUserInfoBean().getIdTypeResponse().getId();
    private String orgNatureName, orgTypeName, orgDetailName, workYearName;
    ...
    public String path = MyApplication.getInstance().getUserInfoBean().getAvatar();
...
//                handleCropError(intent);
    ...
    public void setUserInfo(Map<String, String> params) {
        ...
        if (!TextUtils.isEmpty(orgNatureName)) {
